...
def proj7_page3_save_waste_daily_transaction(request):
    det_weight_1 = float(request.POST['det_weight_1'])
    det_weight_2 = float(request.POST['det_weight_2'])
    det_weight_3 = float(request.POST['det_weight_3'])
    det_weight_4 = float(request.POST['det_weight_4'])
    det_weight_5 = float(request.POST['det_weight_5'])
    det_weight_6 = float(request.POST['det_weight_6'])
    det_weight_7 = float(request.POST['det_weight_7'])
    det_weight_8 = float(request.POST['det_weight_8'])
    det_weight_9 = float(request.POST['det_weight_9'])
    det_weight_10 = float(request.POST['det_weight_10'])

    det_weight_11 = float(request.POST['det_weight_11'])
    det_weight_12 = float(request.POST['det_weight_12'])
    det_weight_13 = float(request.POST['det_weight_13'])
    det_weight_14 = float(request.POST['det_weight_14'])
    det_weight_15 = float(request.POST['det_weight_15'])
    det_weight_16 = float(request.POST['det_weight_16'])
    det_weight_17 = float(request.POST['det_weight_17'])
    det_weight_18 = float(request.POST['det_weight_18'])
    det_weight_19 = float(request.POST['det_weight_19'])
    det_weight_20 = float(request.POST['det_weight_20'])

    det_weight_21 = float(request.POST['det_weight_21'])
    det_weight_22 = float(request.POST['det_weight_22'])
    det_weight_23 = float(request.POST['det_weight_23'])
    det_weight_24 = float(request.POST['det_weight_24'])
    det_weight_25 = float(request.POST['det_weight_25'])
    det_weight_26 = float(request.POST['det_weight_26'])
    det_weight_27 = float(request.POST['det_weight_27'])
